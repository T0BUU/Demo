 ...
 */
public class ClusterManager<T extends ClusterMarker> implements
    ...
    private com.finnair.gamifiedpartnermap.ClusterRenderer<T> mRenderer;
    ...
    public void setRenderer(com.finnair.gamifiedpartnermap.ClusterRenderer<T> view) {
    ...
    public com.finnair.gamifiedpartnermap.ClusterRenderer<T> getRenderer() {
        return mRenderer;
    }
     ...
     */
    public interface OnClusterClickListener<T extends ClusterMarker> {
        /**
     ...
     */
    public interface OnClusterInfoWindowClickListener<T extends ClusterMarker> {
     ...
     */
    public interface OnClusterItemClickListener<T extends ClusterMarker> {
     ...
     */
    public interface OnClusterItemInfoWindowClickListener<T extends ClusterMarker> {
