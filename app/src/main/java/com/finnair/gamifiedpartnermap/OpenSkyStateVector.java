 ...
 */
public class OpenSkyStateVector implements Serializable {
    ...
    public OpenSkyStateVector(String icao24) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OpenSkyStateVector)) return false;

        OpenSkyStateVector that = (OpenSkyStateVector) o;
