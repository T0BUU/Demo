 ...
 */
public class DefaultClusterRenderer<T extends ClusterMarker> implements com.finnair.gamifiedpartnermap.ClusterRenderer<T> {
    private static final boolean SHOULD_ANIMATE = Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB;
    private final GoogleMap mMap;
    private final IconGenerator mIconGenerator;
    private final com.finnair.gamifiedpartnermap.ClusterManager<T> mClusterManager;
    ...
    private com.finnair.gamifiedpartnermap.ClusterManager.OnClusterClickListener<T> mClickListener;
    private com.finnair.gamifiedpartnermap.ClusterManager.OnClusterInfoWindowClickListener<T> mInfoWindowClickListener;
    private com.finnair.gamifiedpartnermap.ClusterManager.OnClusterItemClickListener<T> mItemClickListener;
    private com.finnair.gamifiedpartnermap.ClusterManager.OnClusterItemInfoWindowClickListener<T> mItemInfoWindowClickListener;

    public DefaultClusterRenderer(Context context, GoogleMap map, com.finnair.gamifiedpartnermap.ClusterManager<T> clusterManager) {
        mMap = map;
        mAnimate = true;
